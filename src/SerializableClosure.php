 ...
 * @namespace
 */
namespace Omega\SerializableClosure\SerializableClosure;
...
class SerializableClosure
{
     ...
     * @return object Return the unserialized object class for class.
     */
    protected function unserializeAnonymousClass( array $data ) : object
    {
        // Customize the unserialization of the anonymous class as needed.
