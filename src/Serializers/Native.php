...
class Native implements SerializableInterface
{
     ...
     *
     * @var ?Closure $resolveUseVariables Holds the closure for resolve the variable after unserialization or null.
     */
     ...
     *
     * @var ?ReflectionClosure $reflector Holds the closure reflection or null.
     */
     ...
     * The closure's scope.
     *
     * @var ?ClosureScope $scope Holds the closure scope or null.
     */
